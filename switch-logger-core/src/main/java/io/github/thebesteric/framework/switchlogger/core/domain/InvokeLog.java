...
import io.github.thebesteric.framework.switchlogger.annotation.IgnoreParam;
...
public class InvokeLog extends AbstractEntity {
    ...
    public static final String FEIGN_TAG = "feign";
    public static final String FOREST_TAG = "forest";
